...
{
    /// <summary>
    /// Misc utility functionality. This part is renderer-independent (pure
    /// math, string, and file helpers) so headless tools can compile it;
    /// graphics-coupled helpers live in Utility.Graphics.cs.
    /// </summary>
